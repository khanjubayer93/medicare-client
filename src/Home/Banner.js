...
const Banner = () => {
    ...
    return (
        <div className='max-w-[1350px] lg:h-[780px] m-auto pt-1 pb-16 px-4 relative group'>
            <div style={{ backgroundImage: `url(${slides[currentSlide].url})` }} className='lg:w-full lg:h-full rounded-md bg-center bg-cover duration-500 w-96 h-96'>
            </div>
            {/* Left arrow */}
